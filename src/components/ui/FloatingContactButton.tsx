  ...
  return (
    <>
      <motion.button
        ...
        whileTap={{ scale: 0.97 }}
        className="fixed bottom-6 right-6 z-40 inline-flex items-center gap-3 rounded-full bg-gradient-to-r from-emerald-600 to-teal-600 px-5 py-3 text-sm font-semibold text-white shadow-2xl shadow-emerald-900/30 transition-shadow hover:shadow-emerald-900/40 focus:outline-none focus:ring-2 focus:ring-emerald-400 focus:ring-offset-2 focus:ring-offset-transparent"
            ...
            <motion.div
              ...
              className={`fixed bottom-24 right-6 z-50 w-[calc(100vw-3rem)] max-w-sm overflow-hidden rounded-3xl border shadow-2xl ${
                theme === "dark"
                  ...
                  : "border-emerald-100 bg-white/95 text-stone-900"
              }`}
            >
              ...
              <div className="relative p-6">
                <div className="mb-4 flex items-start justify-between gap-4">
                  <div>
                    <p className="mb-2 inline-flex rounded-full border border-emerald-500/30 bg-emerald-500/15 px-3 py-1 text-xs font-medium uppercase tracking-[0.2em] text-emerald-300">
                      Contact
                    </p>
